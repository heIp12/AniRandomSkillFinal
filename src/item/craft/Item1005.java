...
public class Item1005 extends itemBase{
	public Item1005(Player p){
		super(p);
		itemCode = 1005;
	}
	double hp = 0;
	...
	protected void onStart() {
		new G_ItemSelect(player, 3000);
		Rule.c.get(player).skillmult += 0.15f;
		
		hp = player.getMaxHealth()*0.2;
