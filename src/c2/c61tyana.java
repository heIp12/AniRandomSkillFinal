...
public class c61tyana extends c00main{
	...
	public c61tyana(Player p,Plugin pl,c00main ch) {
		...
		c = this;
		mana = 90;
		if(ARSystem.gameMode == modes.LOBOTOMY) this.p = 20;
	}
	...
	public boolean skill0() {
		...
		delay(()->{
			loc.setPitch(20);
			ARSystem.spellLocCast(player, Local.offset(loc, new Vector(-1.5,0,1)), "c61_sp");
			ARSystem.spellLocCast(player, Local.offset(loc, new Vector(-1.5,0,-1)), "c61_sp");
		},20);
		delay(()->{
			Location locs = Local.offset(loc, new Vector(-3,0.2,-3));
			ARSystem.spellLocCast(player, Local.offset(locs, new Vector(0,0,0)), "c61_sp");
			ARSystem.spellLocCast(player, Local.offset(locs, new Vector(-1.5,0,1)), "c61_sp");
			ARSystem.spellLocCast(player, Local.offset(locs, new Vector(-1.5,0,-1)), "c61_sp");
		},30);
		delay(()->{
			Location locs = Local.offset(loc, new Vector(-3,0.2,3));
		...
		Location loco = Local.offset(loc, new Vector(-5,1,9));
		delay(()->{
			loco.setPitch(20);
			ARSystem.spellLocCast(player, Local.offset(loco, new Vector(0,0,0)), "c61_sp");
			ARSystem.spellLocCast(player, Local.offset(loco, new Vector(-1.5,0,1)), "c61_sp");
			ARSystem.spellLocCast(player, Local.offset(loco, new Vector(-1.5,0,-1)), "c61_sp");
		},40);
		delay(()->{
			Location locs = Local.offset(loco, new Vector(-3,0.2,-3));
			ARSystem.spellLocCast(player, Local.offset(locs, new Vector(0,0,0)), "c61_sp");
			ARSystem.spellLocCast(player, Local.offset(locs, new Vector(-1.5,0,1)), "c61_sp");
			ARSystem.spellLocCast(player, Local.offset(locs, new Vector(-1.5,0,-1)), "c61_sp");
		},40);
		...
		Location locz = Local.offset(loc, new Vector(-5,1,-9));
		delay(()->{
			locz.setPitch(20);
			ARSystem.spellLocCast(player, Local.offset(locz, new Vector(0,0,0)), "c61_sp");
			ARSystem.spellLocCast(player, Local.offset(locz, new Vector(-1.5,0,1)), "c61_sp");
			ARSystem.spellLocCast(player, Local.offset(locz, new Vector(-1.5,0,-1)), "c61_sp");
		},40);
		delay(()->{
			Location locs = Local.offset(locz, new Vector(-3,0.2,-3));
			ARSystem.spellLocCast(player, Local.offset(locs, new Vector(0,0,0)), "c61_sp");
			ARSystem.spellLocCast(player, Local.offset(locs, new Vector(-1.5,0,1)), "c61_sp");
			ARSystem.spellLocCast(player, Local.offset(locs, new Vector(-1.5,0,-1)), "c61_sp");
		},40);
	...
	public boolean tick() {
		...
		if(tk%20 == 0) {
			if(ARSystem.gameMode == modes.LOBOTOMY && AMath.random(2) == 1) mana+=1;
