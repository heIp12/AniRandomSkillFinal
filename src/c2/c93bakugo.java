...
public class c93bakugo extends c00main{
	...
	public boolean tick() {
		...
		if(ARSystem.gameMode == modes.LOBOTOMY) p+=0.25;
		
		if(ARSystem.gameMode == modes.ZOMBIE) p -= frist_loc.distance(player.getLocation())*0.6;
	...
	public boolean entitydamage(EntityDamageByEntityEvent e, boolean isAttack) {
		if(isAttack) {
			...
			if(ARSystem.gameMode == modes.LOBOTOMY) e.setDamage(e.getDamage()*0.35);
		}
		return true;
	}
}
