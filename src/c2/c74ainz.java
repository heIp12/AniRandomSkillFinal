...
public class c74ainz extends c00main{
	...
	public boolean skill1() {
		ARSystem.spellLocCast(player, Local.offset(player.getLocation(), new Vector(1,0,0)), "c74_s1");
		ARSystem.spellLocCast(player, Local.offset(player.getLocation(), new Vector(1,0,1)), "c74_s1");
		ARSystem.spellLocCast(player, Local.offset(player.getLocation(), new Vector(1,0,-1)), "c74_s1");
