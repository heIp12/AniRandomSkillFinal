				...
				for(int i=0; i < 5;i++) {
					if(code[c_count+i] == select) {
						if(i == 0) {
							...
							Location loc = player.getLocation();
							loc.setPitch(0);
							ARSystem.spellLocCast(player, ULocal.offset(loc, new Vector(2,2,1.0 - AMath.random(0, 20)*0.1)), "c996_p3");
						}
						if(i == 1){
							combo++;
							cb = "§aGood!";
							...
							Location loc = player.getLocation();
							loc.setPitch(0);
							ARSystem.spellLocCast(player, ULocal.offset(loc, new Vector(2,1,1.0 - AMath.random(0, 20)*0.1)), "c996_p2");
						}
						if(i == 2){
							combo++;
							cb = "§6Perfect!";
