...
public class h003rentaro extends c00main{
	...
	public boolean entitydamage(EntityDamageByEntityEvent e, boolean isAttack) {
		if(isAttack) {
			if(e.getDamage() >= 2) {
				ARSystem.giveBuff((LivingEntity) e.getEntity(), new Silence((LivingEntity) e.getEntity()), 20);
				ARSystem.giveBuff((LivingEntity) e.getEntity(), new Noattack((LivingEntity) e.getEntity()), 20);
