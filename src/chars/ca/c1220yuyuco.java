...
public class c1220yuyuco extends c00main{
	public int stack = 0;
	Location loc;
	Location locf;
	Location locl;
	...
	public c1220yuyuco(Player p,Plugin pl,c00main ch) {
		super(p,pl,ch);
		number = 1122;
		load();
		text();
		...
		ARSystem.playSound(player, "c122select");
	}
	...
	public boolean skill1() {
		...
		for(int i =0;i<s1; i++) {
			...
			ARSystem.spellLocCast(player, l, "c1122_s1-"+color);
		}
