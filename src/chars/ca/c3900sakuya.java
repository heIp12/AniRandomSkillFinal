...
public class c3900sakuya extends c00main{
	...
	public boolean skill1() {
		...
		if(s1 == 2) {
			ARSystem.spellLocCast(player, ULocal.offset(player.getLocation(), new Vector(0,0,0.2)), "c1039_a2");
			ARSystem.spellLocCast(player, ULocal.offset(player.getLocation(), new Vector(0,0,0)), "c1039_a2");
			ARSystem.spellLocCast(player, ULocal.offset(player.getLocation(), new Vector(0,0,-0.2)), "c1039_a2");
			ARSystem.playSound((Entity)player, "0sword");
			ARSystem.playSound((Entity)player, "c39a3");
		}
		if(s1 == 3) {
			ARSystem.spellLocCast(player, ULocal.offset(player.getLocation(), new Vector(0,0,-0.2)), "c1039_a2");
			ARSystem.spellLocCast(player, ULocal.offset(player.getLocation(), new Vector(0,0,0)), "c1039_a1");
			ARSystem.spellLocCast(player, ULocal.offset(player.getLocation(), new Vector(0,0,0.2)), "c1039_a2");
			ARSystem.spellLocCast(player, ULocal.offset(player.getLocation(), new Vector(0,0,-0.4)), "c1039_a1");
			ARSystem.spellLocCast(player, ULocal.offset(player.getLocation(), new Vector(0,0,0.4)), "c1039_a1");
	...
	public boolean tick() {
		if(tk%2== 0 && s2 > 0) {
			s2--;
			ARSystem.playSound((Entity)player, "0sword");
			ARSystem.spellLocCast(player, ULocal.offset(player.getLocation(), new Vector(-0.5+AMath.random(10)*0.1,0.5+AMath.random(10)*0.1,-0.5+AMath.random(10)*0.1)), "c1039_a"+ AMath.random(2));
