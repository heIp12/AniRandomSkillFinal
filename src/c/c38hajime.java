...
public class c38hajime extends c00main{
	...
	private class gun {
				...
				delay(new Runnable() {
					...
					public void run() {
						if(mybullet > 0) {
							...
							if(E.indexOf(c38hajime.Enchent.TRIPLE) > -1 ){
								shot *= 3;
							}
							if(E.indexOf(c38hajime.Enchent.DOUBLE) > -1 ){
								shot *= 2;
							}
							if(shot > 5) {
		...
		public void damage(LivingEntity e) {
			...
			if(E.indexOf(c38hajime.Enchent.DRAIN) > -1 ){
				ARSystem.heal(player, damage);
			}
			if(E.indexOf(c38hajime.Enchent.EXPLO) > -1 ){
